 ...
 * @returns
 */
export async function getAdminListApi(params: SystemApi.adminListParams) {
  return requestClient.post<SystemApi.adminListResult[]>(
    Api.GET_ADMIN_LIST,
    params,
  );
}
 ...
 * @returns
 */
export async function postAdminAddApi(params: SystemApi.adminAddParams) {
...
export async function getMenuListApi(params?: any) {
  return requestClient.post<SystemApi.menuListResult[]>(
    Api.GET_MENU_LIST,
    params,
  );
}
 ...
 * @returns
 */
export async function postMenuAddApi(params: SystemApi.menuAddParams) {
 ...
 * @returns
 */
export async function getRoleListApi(params?: SystemApi.adminListParams) {
  return requestClient.post<SystemApi.roleListResult[]>(
    Api.GET_ROLE_LIST,
    params,
  );
}
 ...
 * @returns
 */
export async function postRoleAddApi(params: SystemApi.roleAddParams) {
...
export async function getRoleAuthorityApi(params?: any) {
  return requestClient.post<SystemApi.roleAuthorityResult[]>(
